    ...
    public void insertFill(MetaObject metaObject) {
        try {
            if (ObjectUtil.isNotNull(metaObject) && metaObject.getOriginalObject() instanceof BaseEntity baseEntity) {
                ...
                LocalDateTime current = ObjectUtils.notNull(baseEntity.getCreateTime(), DateUtils.getNowLocalDateTime());
                ...
                LocalDateTime date = DateUtils.getNowLocalDateTime();
    ...
    public void updateFill(MetaObject metaObject) {
        try {
            if (ObjectUtil.isNotNull(metaObject) && metaObject.getOriginalObject() instanceof BaseEntity baseEntity) {
                ...
                LocalDateTime current = DateUtils.getNowLocalDateTime();
                baseEntity.setUpdateTime(current);
                ...
                this.strictUpdateFill(metaObject, "updateTime", LocalDateTime.class, DateUtils.getNowLocalDateTime());
            }
        } catch (Exception e) {
            throw new ServiceException("自动注入异常 => " + e.getMessage(), HttpStatus.HTTP_UNAUTHORIZED);
        }
