 ...
 * @author 芋道源码
 */
public class RuoyiPlus改包名 {

    private static final String GROUP_ID = "org.dromara";
    private static final String ARTIFACT_ID = "ruoyi";
    private static final String PACKAGE_NAME = "org.dromara";
    private static final String TITLE = "芋道管理系统";

    /**
     * 白名单文件，不进行重写，避免出问题
     */
//    private static final Set<String> WHITE_FILE_TYPES = new HashSet<String>("gif", "jpg", "svg", "png", // 图片
//        "eot", "woff2", "ttf", "woff",  // 字体
//        "xdb"); // IP 库
    private static final Set<String> WHITE_FILE_TYPES = new HashSet<String>(); // IP 库
...
//        String projectBaseDir = getProjectBaseDir();
        String projectBaseDir = Paths.get("C:\\Users\\lized\\Desktop\\RuoYi-Vue-Plus-dev").toString();
        log.info("[main][原项目路劲改地址 ({})]", projectBaseDir);

        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.eguan";
        String artifactIdNew = "eguan";
        String packageNameNew = "com.eguan";
        ...
        // 写入文件
        files.forEach(file -> {
            log.info("[main][开始重写文件：{}，]", file.getPath() + file.getName());
